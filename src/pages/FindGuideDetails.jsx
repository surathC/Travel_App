...
const FindGuideDetails = () => {
    ...
    const { findGuide } = location.state || {};
    ...
    const [mapUrl, setMapUrl] = useState(() => {
        const [lat, lng] = findGuide.googleMap.split(", ");
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6 mt-8 text-gray-700">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <p>
                                Phone Numbers -{" "}
                                <span className="font-bold">
                                    {Object.entries(findGuide.contactNumber)
            ...
            {/* <div className="bg-white-100">
                <div className="container mx-auto py-10">
                    <h2 className="text-center text-2xl font-bold mb-6">
                        - Some photos from - <br />
                        <span className="text-orange-500">{findGuide.name}</span>
                    </h2>
                    <Swiper
